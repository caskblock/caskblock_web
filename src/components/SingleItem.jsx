        ...
        <div className="space-y-8 lg:space-y-10">
          <div className="rounded-3xl overflow-hidden z-0">
            ...
            <div className="w-full space-y-2.5 mt-4">
              <div
                className="flex items-center justify-between w-full px-4 py-2 font-medium text-left bg-slate-100/80 rounded-lg"
              >
        ...
        <div className="pb-9 space-y-5">
          ...
          <div className="pb-9 pt-14">
            ...
            <div className="mt-8 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
              <button
                className="primary-button relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium px-4 py-3 sm:px-6  bg-primary text-neutral-50 flex-1 focus:outline-none"
                onClick={onClick}
              >
