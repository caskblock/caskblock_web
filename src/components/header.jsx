    ...
    <div className="relative z-10 onTop">
      <div className="container relative flex justify-between items-center space-x-4 xl:space-x-8 px-6">
        <div className="flex justify-start py-5 flex-grow items-center space-x-3 sm:space-x-8 lg:space-x-10">
          <img className="max-h-12 block" src="" alt="logo"/>
        </div>
        <button className="p-2.5 rounded-lg text-neutral-700 focus:outline-none flex items-center justify-center" onClick={() => setDrawerOpen(!drawerOpen)}>
              ...
              <div className="overflow-y-auto w-full max-w-sm h-screen py-2 transition transform shadow-lg ring-1 bg-white divide-y-2 divide-neutral-100">
                <div className="py-6 px-5">
                  <div className="flex items-center justify-between">
                    <img className="hidden max-h-12" src="" alt="PWX"/>
                    <button
                      type="button"
                  ...
                  <div className="flex items-center justify-between py-6 px-5 space-x-2">
                    <button onClick={(e) => buttonAction(e)} className="relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium px-4 py-3 sm:px-6 border bg-primary border-neutral-200 text-neutral-50 primary-button flex-1">{buttonLabel}</button>
                  </div>
                </div>
              </div>
            </div>
